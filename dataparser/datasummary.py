...
#model_df = pd.read_csv("resultsR0Decay.csv")
model_df = pd.read_csv("results4R0sOnly.csv")
...
params_df= pd.read_csv("parameters4R0sOnly.csv")
...
#biggest_infections = max_infected_perRun[max_infected_perRun.between(max_infected_perRun.quantile(0.5), max)]
#biggest_infections = max_infected_perRun[max_infected_perRun.between(max_infected_perRun.quantile(0.1), max_infected_perRun.quantile(0.4))]
biggest_infections = max_infected_perRun[max_infected_perRun.between(max_infected_perRun.quantile(0.1), max_infected_perRun.quantile(0.9))]
biggest_infections = biggest_infections.to_frame()
print(max_infected_perRun)
...
print("Social Distancing R0's for simulations above the median:")
print()
